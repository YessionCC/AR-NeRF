...
from insert.insert_utils import show_im
...
class NeRFSystem(LightningModule):
    def __init__(self, hparams):
        ...
        self.model = NGP(scale=self.hparams.scale, rgb_act=rgb_act, use_raw_HDR=self.hparams.use_EXR)
    ...
    def forward(self, batch, split):
        ...
        if test_time:
            kwargs['val_batch_size'] = self.val_batch_size
    ...
    def validation_step(self, batch, batch_nb):
        ...
        #show_im(results['depth'].reshape(800,800))
